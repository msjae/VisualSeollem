...
namespace ORB_SLAM2
{
    ...
    {
        EASY_BLOCK("KeyFrameDatabase::add()", profiler::colors::Amber300);
    ...
    {
        EASY_BLOCK("KeyFrameDatabase::erase()", profiler::colors::Amber300);
        unique_lock<mutex> lock(mMutex);
    ...
    {
        EASY_BLOCK("KeyFrameDatabase::clear()", profiler::colors::Amber300);
